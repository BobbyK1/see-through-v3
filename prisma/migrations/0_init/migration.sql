...
CREATE TABLE "public"."transactions" (
    ...
    "user_id" UUID,
    "price" VARCHAR,
    "listing_agent" VARCHAR,
    "co_listing_agent" VARCHAR,
    "address" VARCHAR,
    "mls_id" VARCHAR,
...
-- AddForeignKey
ALTER TABLE "public"."transactions" ADD CONSTRAINT "transactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
