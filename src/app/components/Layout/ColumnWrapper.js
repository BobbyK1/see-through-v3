...
export default function ColumnWrapper({ title, links, content, ...props }) {
    ...
    return (
        <Box minW="64" maxW="64" display="flex" flexDir="column" h="full" borderRightWidth="thin" borderColor={useColorModeValue("#e6e8eb", "#2e2e2e")}>
                <Box maxH="14" minH="14" px="5" display="flex" alignItems="center" borderBottomWidth="thin" borderColor={useColorModeValue("#e6e8eb", "#2e2e2e")}>
